        ...
        if user_messages:
            ...
            try:
                ...
                prompt = (
                    ...
                    f"5. **Enviar o compartir** (acciones como 'enviar', 'compartir', 'mandar', 'mándame', 'enviar por correo'):\n"
                    ...
                    f"   - Si el usuario no proporciona un destinatario, le tienes que responder que tiene que ingresar el destinatario\n"
